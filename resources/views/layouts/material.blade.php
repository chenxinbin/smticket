...
<head>
    ...
    <title>@yield('title') 开源工单系统</title>
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0">
                        ...
                        <li class="nav-item hidden-sm-down search-box"> <a class="nav-link hidden-sm-down text-muted waves-effect waves-dark" href="javascript:void(0)"><i class="ti-search"></i></a>
                            <form class="app-search">
                                <input type="text" class="form-control" placeholder="搜索"> <a class="srh-btn"><i class="ti-close"></i></a> </form>
                        </li>
                        <!-- ============================================================== -->
                        <!-- Messages -->
                        <!-- ============================================================== -->
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    ...
                                    <li><a href="#"><i class="ti-user"></i> 我的资料</a></li>
                                    <li><a href="#"><i class="ti-email"></i> 收件箱</a></li>
                                    <li role="separator" class="divider"></li>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="nav-small-cap">功能菜单</li>
                        <li> <a class="has-arrow waves-effect waves-dark"><i class="mdi mdi-gauge"></i><span class="hide-menu">概览 </span></a></li>
                        <li> <a class="has-arrow waves-effect waves-dark" aria-expanded="false"><i class="mdi mdi-laptop-windows"></i><span class="hide-menu">工单管理</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{route('ticket.list')}}">工单列表</a></li>
                                <li><a href="{{route('ticket.create')}}">新建工单</a></li>
                                <li><a href="{{route('ticket.undo')}}">待办事项</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">系统管理</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="app-contact-detail.html">数据字典</a></li>
                                <li><a href="app-contact.html">用户管理</a></li>
                                <li><a href="app-contact2.html">权限管理</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-email"></i><span class="hide-menu">账户设置</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="app-calendar.html">用户资料</a></li>
                                <li><a href="app-chat.html">修改密码</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
